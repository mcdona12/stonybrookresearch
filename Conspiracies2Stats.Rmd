...
<<<<<<< HEAD
summary(covid_data$MIS_total)
summary(covid_data$PAS_total)
summary(covid_data$PhAnS_score)
summary(covid_data$Social_Anhedonia_Score)
summary(covid_data$Green_Total_Short_Score)

covid_data %>%
  dplyr::select(MIS_total, PAS_total, PhAnS_score, Social_Anhedonia_Score, Green_Total_Short_Score)
=======
...
summary(covid_reg3)
>>>>>>> 0c9a49a0e21f58c921fec8ae2171ab0b17d72228
```
