...
```{r}
ggplot(covid_data, aes(x = Green_Total_Short_Score, y = COVID_conspiracies_total)) + 
         geom_point() +
...
ggplot(covid_data, aes(x=MIS_total, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE)+
         xlab ("MIS") +
         ylab ("COVID-19 CT")
...
ggplot(covid_data, aes(x=PAS_total, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE)+
         xlab ("PAS")+
         ylab ("COVID-19 CT")
...
ggplot(covid_data, aes(x=PhAnS_score, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE)+
         xlab ("PhAnS")+
         ylab ("COVID-19 CT")
...
ggplot(covid_data, aes(x=Social_Anhedonia_Score, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE)+
         xlab ("SAS")+
         ylab ("COVID-19 CT")
...
ggplot(covid_data, aes(x=IUS_Total_Score, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE) +
...
ggplot(covid_data, aes(x=STAIT_total, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE) +
         #stat_cor(cor.coef.name = "r")+
         xlab ("STAIT")+
...
ggplot(covid_data, aes(x=STAIS_total, y=COVID_conspiracies_total)) + 
         geom_point() +
         geom_smooth(method=lm, size=1.25, se=FALSE) +
         #stat_cor(cor.coef.name = "r")+
         xlab ("STAIS")+
