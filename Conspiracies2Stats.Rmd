...
covid_reg_int4 <- lm(COVID_conspiracies_total ~ Demographics_societal + Demographics_economic + MIS_total + PAS_total + PhAnS_score + Social_Anhedonia_Score + Green_Total_Short_Score + Demographics_societal:Green_Total_Short_Score, data = covid_data)
summary(covid_reg_int4)
